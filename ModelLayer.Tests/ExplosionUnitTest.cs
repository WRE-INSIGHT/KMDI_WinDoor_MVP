...
namespace ModelLayer.Tests
{
    ...
    public class ExplosionUnitTest
    {
        ...
        public void ChkList_SinglePanelFixedWindow()
        {
            ...
            Assert.AreEqual("pcs", dt.Rows[0]["Unit"].ToString());
            ...
            Assert.AreEqual("pcs", dt.Rows[1]["Unit"].ToString());
            ...
            Assert.AreEqual("pcs", dt.Rows[2]["Unit"].ToString());
            ...
            Assert.AreEqual("pcs", dt.Rows[3]["Unit"].ToString());
            ...
            Assert.AreEqual("pcs", dt.Rows[4]["Unit"].ToString());
            ...
            Assert.AreEqual("pcs", dt.Rows[5]["Unit"].ToString());
            ...
            Assert.AreEqual("pcs", dt.Rows[6]["Unit"].ToString());
            ...
            Assert.AreEqual("pcs", dt.Rows[7]["Unit"].ToString());
            ...
            Assert.AreEqual("pcs", dt.Rows[11]["Unit"].ToString());
