namespace PresentationLayer.Views
{
    partial class RDLCReportCompilerView
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txt_GuSubtotal.Controls.Add(this.txtbx_SummaryLessD);
            this.txt_GuSubtotal.Controls.Add(this.chkbx_SummaryLessD);
            this.txt_GuSubtotal.Controls.Add(this.btnCompileReport);
            this.txt_GuSubtotal.Controls.Add(this.txt_SummaryVat);
            this.txt_GuSubtotal.Controls.Add(this.panel5);
            this.txt_GuSubtotal.Controls.Add(this.txt_oftexpenses);
            this.txt_GuSubtotal.Controls.Add(this.chkbox_showVat);
            this.txt_GuSubtotal.Controls.Add(this.chklst_glassType);
            this.txt_GuSubtotal.Controls.Add(this.txt_guVat);
            this.txt_GuSubtotal.Controls.Add(this.chkbx_guShowVat);
            this.txt_GuSubtotal.Controls.Add(this.cmb_guNotedBy);
            this.txt_GuSubtotal.Controls.Add(this.chkbx_guShowNotedBy);
            this.txt_GuSubtotal.Controls.Add(this.cmb_guReviewedBy);
            this.txt_GuSubtotal.Controls.Add(this.chkbx_guShowReviewedBy);
            this.txt_GuSubtotal.Controls.Add(this.cmb_GlassType);
            this.txt_GuSubtotal.Controls.Add(this.label6);
            this.txt_GuSubtotal.Controls.Add(this.txtbox_rowlimit);
            this.txt_GuSubtotal.Controls.Add(this.chkbox_subtotal);
            this.txt_GuSubtotal.Controls.Add(this.panel4);
            ...
            this.txt_GuSubtotal.ResumeLayout(false);
            this.txt_GuSubtotal.PerformLayout();
        ...
        private System.Windows.Forms.Panel txt_GuSubtotal;
