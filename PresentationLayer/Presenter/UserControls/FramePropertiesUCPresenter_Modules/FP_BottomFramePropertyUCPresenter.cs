    ...
    public class FP_BottomFramePropertyUCPresenter : IFP_BottomFramePropertyUCPresenter, IPresenterCommon
    {
        ...
        private void _fp_bottomFramePropertiesUC_cmbbotFrameProfileSelectedValueChangedRaised(object sender, EventArgs e)
        {
            if (!_initialLoad)
            {
                ...
                if (fzoom >= 0.50f)
                {
                    if (botft == BottomFrameTypes._None || botft == BottomFrameTypes._7789 || botft == BottomFrameTypes._9C66 || botft == BottomFrameTypes._A166)
                    {
                ...
                else if (fzoom <= 0.26f)
                {
                    ...
                    else if (botft == BottomFrameTypes._7789 || botft == BottomFrameTypes._9C66 || botft == BottomFrameTypes._A166 || botft == BottomFrameTypes._None)
                    {
