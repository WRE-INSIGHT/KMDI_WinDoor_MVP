...
namespace PresentationLayer.Presenter.UserControls.WinDoorPanels
{
    public class MultiPanelTransomUCPresenter : IMultiPanelTransomUCPresenter, IPresenterCommon
    {
        ...
        private void _multiPanelTransomUC_flpMulltiPaintEventRaised(object sender, PaintEventArgs e)
        {
            ...
            if (_frameUCP != null && _multiPanelTransomUCP == null && _multiMullionUCP_given == null) //if inside Frame
            {
            ...
            else if (_frameUCP != null && _multiPanelTransomUCP != null && _multiMullionUCP_given == null) //if inside MultiTransom
            {
            ...
            else if (_frameUCP != null && _multiPanelTransomUCP == null && _multiMullionUCP_given != null) //if inside MultiPanelMullion
            {
                if (_multiPanelModel.MPanel_Placement == "First")
                {
