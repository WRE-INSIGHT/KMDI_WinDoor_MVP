...
{
    public partial class Thumbs_CasementPanelUC : UserControl
    {
        public Thumbs_CasementPanelUC()
        {
            InitializeComponent();
        }

        private void Thumbs_CasementPanelUC_Paint(object sender, PaintEventArgs e)
        {
