...
namespace ModelLayer.Model.Quotation.WinDoor
{
    public class WindoorModel : IWindoorModel, INotifyPropertyChanged
    {
        ...
        private float[] _arr_zoomPercentage = { 0.10f, 0.13f, 0.17f, 0.26f, 0.40f, 0.50f, 1.0f };
        ...
        public float GetZoom_forRendering()
        {
            ...
            else if (area > 1000000 && area <= 2250000) // (1000w x 1001h / 1001w x 1000h) to 1500w x 1500h
            {
                zm = _arr_zoomPercentage[4];
            }
            else if (area > 2250000 && area <= 4000000) // (1500w x 1501h / 1501w x 1500h) to 2000w x 2000h
            {
